...
from app.routers import bets, analyze, odds, sentiment, predictions, notion, agents, google_sheets, player_props
...
app.include_router(player_props.router, prefix="/api/v1", tags=["player-props"])
